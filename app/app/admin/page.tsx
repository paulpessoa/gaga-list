      ...
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex bg-zinc-900 p-1.5 rounded-2xl border border-white/5">
            <button
              onClick={() => { setActiveTab("finance"); trigger("light"); }}
            ...
            <button
              onClick={() => { setActiveTab("curation"); trigger("light"); }}
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
             <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-lg font-black uppercase tracking-widest">Curadoria de Novos Produtos</h2>
                </div>
                <div className="relative">
                  <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-500" />
                  <input 
             ...
             <div className="bg-zinc-900/30 border border-white/5 rounded-[2.5rem] overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-white/5">
                        <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-zinc-500">Produto Sugerido</th>
                        <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-zinc-500">Usuário</th>
                        ...
                        <tr>
                          <td colSpan={5} className="px-6 py-20 text-center">
                             <div className="flex flex-col items-center gap-4">
                                ...
                                <p className="text-zinc-500 font-bold uppercase tracking-widest text-[10px]">Nenhum produto pendente para curadoria</p>
                             </div>
                          </td>
                        </tr>
                      ) : (
                            ...
                            <td className="px-6 py-4">
                               <div className="flex items-center gap-3">
                                  ...
                                  <div className="flex flex-col">
                                    ...
                                    <span className="text-[10px] text-zinc-500 uppercase tracking-widest font-black">{prod.brand || 'Marca Genérica'}</span>
                                  </div>
                               </div>
                            </td>
                            <td className="px-6 py-4">
                               <div className="flex flex-col">
                                  <span className="text-xs font-bold text-zinc-300">{prod.profiles?.full_name}</span>
                                  <span className="text-[9px] text-zinc-500 font-mono">{prod.profiles?.email}</span>
                               </div>
                            </td>
                            <td className="px-6 py-4">
