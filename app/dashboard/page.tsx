      ...
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="hidden md:block text-sm text-zinc-500">
            Organize suas compras colaborativas
          </p>
        </div>
          ...
          lists?.map((list) => (
            <div key={list.id} className="relative group">
              <Link
                ...
                className="glass-panel rounded-2xl p-6 flex flex-col justify-between h-40 hover:border-zinc-700 transition-colors cursor-pointer block"
              >
                ...
                <div className="flex items-center justify-between text-xs text-zinc-500">
                  <span>
                    Atualizado {new Date(list.updated_at).toLocaleDateString()}
                  </span>
