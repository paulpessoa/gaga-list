...
export default function ProfilePage() {
  ...
  const handleTogglePush = async () => {
    ...
    try {
      ...
      alert(
        "Erro: Para ativar notificações, o site precisa estar em HTTPS (SSL)."
      )
    } finally {
          ...
          <form onSubmit={handleSave} className="space-y-6">
            <div className="bg-gradient-to-br from-indigo-500/10 to-purple-600/10 rounded-3xl p-6 border border-indigo-500/20 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Link
                  href="/app/credits"
                  className="px-4 py-2 rounded-xl bg-indigo-500 text-white text-[10px] font-black uppercase tracking-widest shadow-lg shadow-indigo-500/20 active:scale-95 transition-all"
                >
                  Ver Meus Grãos
                </Link>
              </div>
              <p className="text-xs text-zinc-500">
                Acompanhe seu saldo e recarregue seus créditos mágicos para usar
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onBlur={() => handleSave()}
                    type="text"
                    className="w-full bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-white/10 rounded-2xl py-3.5 px-5 text-zinc-900 dark:text-white focus:ring-2 focus:ring-indigo-500/50 outline-none transition-all"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-zinc-500 ml-1 uppercase tracking-widest">
            ...
            <div className="bg-zinc-50 dark:bg-zinc-900/20 rounded-3xl p-6 border border-zinc-200 dark:border-white/5 space-y-4">
              ...
              <button
                ...
                type="submit"
                className="w-full py-3 bg-zinc-900 dark:bg-white text-white dark:text-black rounded-xl font-bold text-xs uppercase tracking-widest transition-all active:scale-95 disabled:opacity-20"
              >
                Alterar Senha
              </button>
            </div>
            ...
            {message && (
              <div
                className={`p-4 rounded-2xl text-xs font-bold text-center animate-in fade-in zoom-in-95 ${message.includes("Erro") ? "bg-red-500/10 text-red-400 border border-red-500/20" : "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20"}`}
              >
                {message}
              </div>
            )}
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="w-full py-4 bg-zinc-100 dark:bg-zinc-900/50 hover:bg-zinc-200 dark:hover:bg-zinc-900 text-zinc-500 dark:text-zinc-400 rounded-2xl font-bold transition-all flex items-center justify-center gap-2 border border-zinc-200 dark:border-white/5 active:scale-95"
              >
              ...
              <div className="bg-red-500/5 dark:bg-red-500/10 rounded-3xl p-6 border border-red-500/10 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-zinc-500 leading-relaxed">
                    Sua conta e listas serão deletadas em 30 dias. Confirme seu
