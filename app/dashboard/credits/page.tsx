  ...
  return (
    <main className="min-h-screen p-6 md:p-12 max-w-2xl mx-auto flex flex-col gap-8 pb-32 bg-white dark:bg-zinc-950 transition-colors duration-300">
      ...
      <div className="space-y-4">
        <h3 className="text-xs font-black uppercase tracking-[0.2em] text-zinc-400 ml-2">
          Custo das Mágicas
        </h3>
      ...
      <div className="bg-zinc-50 dark:bg-zinc-900/40 border border-zinc-200 dark:border-white/5 rounded-3xl p-6 flex flex-col items-center text-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-500 mt-1 max-w-[250px] mx-auto">
            Apoie o projeto e recarregue sua energia para continuar criando.
          </p>
        </div>
        <Link
      ...
      <div className="space-y-4">
        ...
        {isLoading ? (
          ...
          <div className="text-center text-sm text-zinc-500 py-8 bg-zinc-50 dark:bg-zinc-900/20 rounded-3xl border border-dashed border-zinc-200 dark:border-white/5">
            Você ainda não usou nenhuma mágica.
          </div>
        ) : (
          <div className="flex flex-col gap-2">
            {logs.map((log) => (
              ...
              >
                ...
                <span className="text-xs font-black text-rose-500 bg-rose-500/10 px-2 py-1 rounded-md">
                  {log.cost}
                </span>
              </div>
            ))}
