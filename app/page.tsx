      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 z-10 mt-16 md:mt-24">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto animate-in fade-in slide-in-from-bottom-10 duration-700 delay-300">
          <button
            ...
            className="px-8 py-4 text-base font-semibold bg-zinc-100 text-zinc-900 hover:bg-white rounded-full transition-transform hover:scale-105 flex items-center justify-center gap-2 cursor-pointer"
          >
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-10 text-left">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                Convide qualquer pessoa para editar a lista com você. Veja os
                itens sendo marcados em tempo real na sua tela.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                Sem internet no supermercado? Sem problemas. O app funciona
                offline e sincroniza tudo automaticamente quando a conexão
                voltar.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                Arquitetura blindada. O frontend nunca acessa o banco
                diretamente. Seus dados protegidos por rotas de API seguras.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="glass-panel w-full max-w-md rounded-3xl p-8 relative shadow-2xl border border-white/10 animate-in zoom-in-95 duration-200">
            ...
            <p className="text-zinc-400 text-sm mb-6">
              Acesse suas listas de compras colaborativas.
            </p>
            ...
            <form onSubmit={handleAuth} className="flex flex-col gap-4">
              ...
              {message && (
                <div
                  className={`p-3 rounded-xl text-sm text-center ${message.includes("Erro") || message.includes("inválida") ? "bg-red-500/10 text-red-400 border border-red-500/20" : "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20"}`}
                >
                  {message}
                </div>
              )}
