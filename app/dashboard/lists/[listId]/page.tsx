        ...
        <div className="flex flex-col gap-3">
          {isLoading ? (
            ...
            <div className="glass-panel rounded-[2rem] p-12 flex flex-col items-center justify-center gap-4 text-center border border-white/5 bg-zinc-950/40">
              <div className="w-20 h-20 rounded-full bg-indigo-500/10 flex items-center justify-center mb-2">
                <ShoppingCart className="w-10 h-10 text-indigo-400 opacity-20" />
              </div>
              <div>
                ...
                <div className="flex items-center gap-4 flex-1 cursor-pointer" onClick={() => handleToggleItem(item)}>
                  <button className="transition-colors">
                    {item.is_purchased ? (
                      ...
                      <Circle className="w-6 h-6 text-zinc-700 group-hover:text-indigo-500" />
                    )}
                  </button>
