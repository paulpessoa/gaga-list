        ...
        {gpsPermission === "denied" ? (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 bg-zinc-950 p-8 text-center">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-white text-black rounded-xl font-black text-[10px] uppercase tracking-widest active:scale-95 transition-all"
            >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-zinc-950">
            ...
            {gpsPermission === "prompt" && (
              <button
                onClick={requestGPS}
                className="mt-4 px-4 py-2 bg-indigo-500 text-white rounded-lg text-xs font-bold uppercase tracking-widest"
              >
                Ativar GPS
              </button>
            )}
